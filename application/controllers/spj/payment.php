...
class Payment extends MY_Controller
{
    function __construct() 
    {
        ...
        $this->load->model(array('spj/t_payment_m', 'masterdata/m_drivers_m', 'log/l_paylog_m', 'temp/p_numberingtemp_m'));
    }
    ...
    function form($type, $id)
    {
        ...
        if ($type == 'ks')
        {
            ...
            $n = $this->p_numberingtemp_m->useme('NTKS', $this->user->UserID, $this->user->Branch);
            $form = array(
                array(
                    'title' => 'Data Pribadi',
                    'col0' => array(
                        array('label'=>'No Bukti','field'=>  form_input('L_PayLogNumber', $n, 'readonly=readonly autocomplete=off') .
