                ...
                <div class="tab_container">
                    ...
                    <div id="tabb2" class="tab_content">
                        ...
                        <div class="fluid widget" style="margin-top:15px !important">
                            ...
                            <form style="" name="formusagedetail" onsubmit="return false" class="main" action="">
                            <fieldset style="overflow:hidden">
                                            ...
                                            <div style="margin-left:0px" class="grid6">
                                                <div class="fluid">
                                                    <div class="formRow">
                                                        ...
                                                        <div class="grid6">
                                                            <?= form_input('T_UsageDetailM_SparePartsName', '', 'autocomplete=off') ?>
                                                            <?= /*form_dropdown('T_PurchasingDetailM_SparePartsCode', array(''=>''), '', 'class=select style=width:100% onchange="get_info_price($(this).val())"')*/'' ?>
                                                        </div>
                                                        <div class="grid3">
                                                            <?= form_input('T_UsageDetailM_SparePartsCode', '', 'autocomplete=off readonly=readonly') ?>
                                                        </div>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="formRow noBorderB">
                                                        <div class="grid3"><label>Qty</label></div>
                                                        <div class="grid2"><input type="text" name="T_UsageDetailQty" class="maskNum rtl-inputf" /></div>
                                                        <div class="clear"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="grid6">
                                                <div class="fluid">
                                                    <div class="formRow">
                                                        ...
                                                        <div class="grid3">
                                                            <input type="text" name="T_UsageDetailPrice" class="maskNum rtl-inputf" />
                                                        </div>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="formRow noBorderB">
                                                        ...
                                                        <div class="grid9">
                                                            <div class="grid2">
                                                                <input type="text" name="T_UsageDetailDiscount" class="maskNum rtl-inputf" />
                                                            </div>
                                                            <div class="grid6">
                                                                <a class="buttonS bGreen " href="javascript:;" style="float:right" onclick="add_item($('input[name=T_UsageDetailM_SparePartsCode]').val())">Tambah</a>
                                                            </div>
                                                        </div>
                                                        <div class="clear"></div>
                                                    </div>
