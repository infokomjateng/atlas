...
class T_purchasing_m extends MY_Model
{
    function __construct()
    {
        $this->table_name = 't_purchasing';
        $this->primary_key = 'T_PurchasingID';
        $this->active_field = 'IsActive';
    }
    
    function get($ids = false)
    {
        $this->db->join('t_purchasingdetail', 'T_PurchasingID = T_PurchasingDetailT_PurchasingID AND T_PurchasingIsActive = T_PurchasingDetailIsActive', 'left');
